...
void main() {
  ...
  Map<String, dynamic> countriesData = jsonDataMap['data'];

  // Extract country names from the data
  List countryNames = countriesData.values.map((countryData) => countryData['country']).toList();

  // Generate a random country name
  String randomCountry = countryNames[Random().nextInt(countryNames.length)];

  print('Random Country: $randomCountry');
}
